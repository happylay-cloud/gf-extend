...
func (x *OrderRequest) Reset() {
	*x = OrderRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_hgrpc_1_proto_msgTypes[0]
...
func (*OrderRequest) Descriptor() ([]byte, []int) {
	return file_hgrpc_1_proto_rawDescGZIP(), []int{0}
}
...
func (x *OrderInfo) Reset() {
	*x = OrderInfo{}
	if protoimpl.UnsafeEnabled {
		mi := &file_hgrpc_1_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*OrderInfo) Descriptor() ([]byte, []int) {
	return file_hgrpc_1_proto_rawDescGZIP(), []int{1}
}
...
var File_hgrpc_1_proto protoreflect.FileDescriptor

var file_hgrpc_1_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x68, 0x67, 0x72, 0x70, 0x63, 0x5f, 0x31, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	...
	0x00, 0x30, 0x01, 0x42, 0x0e, 0x5a, 0x0c, 0x74, 0x65, 0x73, 0x74, 0x2f, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x65, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_hgrpc_1_proto_rawDescOnce sync.Once
	file_hgrpc_1_proto_rawDescData = file_hgrpc_1_proto_rawDesc
)

func file_hgrpc_1_proto_rawDescGZIP() []byte {
	file_hgrpc_1_proto_rawDescOnce.Do(func() {
		file_hgrpc_1_proto_rawDescData = protoimpl.X.CompressGZIP(file_hgrpc_1_proto_rawDescData)
	})
	return file_hgrpc_1_proto_rawDescData
}

var file_hgrpc_1_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_hgrpc_1_proto_goTypes = []interface{}{
	(*OrderRequest)(nil), // 0: message.OrderRequest
	(*OrderInfo)(nil),    // 1: message.OrderInfo
}
var file_hgrpc_1_proto_depIdxs = []int32{
...
func init() { file_hgrpc_1_proto_init() }
func file_hgrpc_1_proto_init() {
	if File_hgrpc_1_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_hgrpc_1_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_hgrpc_1_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_hgrpc_1_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_hgrpc_1_proto_goTypes,
		DependencyIndexes: file_hgrpc_1_proto_depIdxs,
		MessageInfos:      file_hgrpc_1_proto_msgTypes,
	}.Build()
	File_hgrpc_1_proto = out.File
	file_hgrpc_1_proto_rawDesc = nil
	file_hgrpc_1_proto_goTypes = nil
	file_hgrpc_1_proto_depIdxs = nil
}
